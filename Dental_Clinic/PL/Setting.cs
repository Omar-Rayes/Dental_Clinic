...
namespace Dental_Clinic.PL
{
    public partial class Setting : Form
    {
        ...
        private void Btn_SaveSetting_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(RText_Name.Text) || string.IsNullOrEmpty(RText_Number.Text) || string.IsNullOrEmpty(RText_Email.Text)||Pic_Box.Image==null)
            {
        ...
        private void Btn_LoadSetting_Click(object sender, EventArgs e)
        {
               ...
               try
                ...
                catch (Exception ex) { MessageBox.Show("لا يوجد صورة محفوظة في إعدادات البرنامج ","خطأ",MessageBoxButtons.OK,MessageBoxIcon.Error); }
