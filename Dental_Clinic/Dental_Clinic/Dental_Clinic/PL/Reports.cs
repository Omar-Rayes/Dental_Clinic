...
namespace Dental_Clinic.PL
{
    public partial class Reports : Form
    {
        ...
        {     
            try
            {
                if (Convert.ToInt32(Com_RPaient.SelectedValue) != 0)
                {
                    ...
                    Com_Patient = Convert.ToInt32(Com_RPaient.SelectedValue);
        ...
        private void Btn_Reset_Enter(object sender, EventArgs e)
        {
            Com_RPaient.SelectionLength = 0;
        }

        private void Com_RPaient_DropDownClosed(object sender, EventArgs e)
        {
            Com_RPaient_SelectedIndexChanged(sender, e);
            Com_RPaient.DropDownStyle = ComboBoxStyle.DropDownList;
            label1.Focus();
        }
        ...
        {
            PL.Frm_Print_Report PR = new Frm_Print_Report();
            PR.ShowDialog();
        }
    }
}
